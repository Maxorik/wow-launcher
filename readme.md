# warmane-vote
Скрипт позволяет проголосовать на сайте - актуально, если есть несколько аккаунтов
...
Ваши настройки (логин\пароль) никуда не уходят и используются только файлом wow-launch.exe для запуска клиента. 

Если есть сомнения, можно собрать лаунчер самому:
